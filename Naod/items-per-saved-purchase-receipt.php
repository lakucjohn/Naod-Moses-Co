...
<div id="printable-document">
    ...
    if(isset($_POST['document']) && isset($_POST['supplier'])) {

        $documentId = $_POST['document'];
        $supplierId = $_POST['supplier'];

        $getDocumentContentSql = "SELECT * FROM purchases_receipt_content WHERE receipt_number='$documentId' AND supplier='$supplierId'";
