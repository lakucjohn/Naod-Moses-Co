...
if($getMaxIdRun = mysqli_query($db_conn,$getMaxId)){
    ...
    $nextReceiptNumber = $maxId['id']+1;
    if(strlen((string)$nextReceiptNumber)==1){
        $nextReceiptNumber = '000'.$nextReceiptNumber;
    }elseif (strlen((string)$nextReceiptNumber)==2){
        $nextReceiptNumber = '00'.$nextReceiptNumber;
    }elseif (strlen((string)$nextReceiptNumber)==3){
        $nextReceiptNumber = '0'.$nextReceiptNumber;
    }
}
    ...
    <div class="row">
        ...
        <div class="card content-card">
            <div class="row">
                ...
                <div class="col-md-8">
                    <h3><div id="receiptNo"><?php echo $nextReceiptNumber; ?></div></h3>
                </div>
            </div>
            <hr>
            <div class="card-body">
