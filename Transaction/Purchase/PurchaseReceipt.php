...
#This function generates a 7 character Id
...
#Manipulating data from the interface passed by ajax post request
if(isset($_POST['receiptName']) && isset($_POST['receiptDate']) && isset($_POST['receiptNumber']) && isset($_POST['receiptAmount'])){
    ...
    #Checking if the owner (Supplier) already exists
