...
#Clearing a credit supply
require '../CreditCleared.php';
class DebtorsClearance extends CreditCleared{

    private $personType = 'customer';

    #Dictating the the settings of a document used for clearing a credit supply
    ...
    #Registering a payment used to clear a credit supply
    ...
    #Editing the content of a document used to clear a credit supply
    ...
    #Deleting the document used for clearing a credit supply
